...
//This is very similar to the code calculating the density auto-covariance matrix. 
...
int main(int argc, char **argv) {
	...
	for (veltype=0; veltype<1; veltype++) { //veltype determines which power spectrum to use.
	...
	for (i=0; i<niter; i++) {
        ...
        if (indi == indj) {
            ...
            printf("%d, %lf, %lf, %lf, %lf\n", indi, datagrid_x[indi], datagrid_y[indi], datagrid_z[indi], conv_pk_gal_0_0[indi][indi]);
        } else {
			...
			double cov_0_0 = 0, cov_0_2 = 0, cov_0_4 = 0, cov_0_6 = 0, cov_0_8 = 0, cov_0_10 = 0, cov_0_12 = 0;//Different to the density auto-covariance matrix, we ignored the effect of redshift space distortion here. 
	...
	for (veltype=0; veltype<1; veltype++) {
		for (i=0; i<7; i++) {
