...
double conv_integral(double kmin, double kmax, double dist, int abtype, int ell, int pq, int gridcorr, int damping) {
...
void write_cov(char * covfile, int ncov, double ** cov, int order) {
