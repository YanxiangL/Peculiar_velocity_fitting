...
4. To run the python code, you need to install numpy, scipy, emcee, astropy and pandas. It reads in a config file (config.ini) that contains the input cosmological parameters and the location of the data and random files. Remember to change the config file if you are using a different dataset. <br />
...
7. The mocks and random of SDSS can be accessed through this website https://zenodo.org/record/6640513. <br />
8. To copy this repository, run "git clone https://github.com/YanxiangL/Peculiar_velocity_fitting.git --branch desi". <br />
