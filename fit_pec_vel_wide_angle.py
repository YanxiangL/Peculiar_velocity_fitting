...
# datafile = str("MOCK_HAMHOD_SDSS_v4_R"+str(int(19000+file_num))+"."+str(dot_num)+"_err_corr")
...
for i in range(N_sigmau):
    ...
    data_file_conv_vv = str('/data/s4479813/wide_angle_covariance_k0p002_0p150_gridcorr20_vv_sigmau%03d.dat' %(int(10.0*i)))
    ...
    data_file_conv_vv_ng = str('/data/s4479813/wide_angle_covariance_k0p002_0p150_gridcorr20_vv_ng_sigmau%03d.dat' %(int(10.0*i)))
